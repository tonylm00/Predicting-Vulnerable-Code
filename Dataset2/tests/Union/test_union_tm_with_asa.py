...
class TestAnotherOption:
    ...
    def test_case_3(self):
        with pytest.raises(AttributeError):
            assert another_option(line_asa="", line_tm=None, class_element=None)

    def test_case_4(self):
        with pytest.raises(AttributeError):
            assert another_option(line_asa="a,b,c", line_tm=None, class_element=None)

    def test_case_5(self):
        with pytest.raises(ValueError):
            assert another_option(line_asa="a,b,c", line_tm=None, class_element="")

    def test_case_6(self):
        with pytest.raises(ValueError):
            assert another_option(line_asa="a,b,c", line_tm=None, class_element="pos")
    ...
    def test_case_8(self):
        with pytest.raises(ValueError):
            assert another_option(line_asa=None, line_tm="", class_element=None)

    def test_case_9(self):
        with pytest.raises(ValueError):
            assert another_option(line_asa=None, line_tm="a,b,c", class_element=None)

    def test_case_10(self):
        with pytest.raises(ValueError):
            assert another_option(line_asa=None, line_tm="a,b,c", class_element="")
