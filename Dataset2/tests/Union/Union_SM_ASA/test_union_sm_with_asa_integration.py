import pytest
from Dataset2.Union.Union_SM_ASA import Union_SMwithASA
...
class TestUnionSMwithASAIntegration:
    ...
    def test_case_2(self, fixture_only_sm, base_fixture):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_3(self, base_fixture, fixture_sm_asa_not_valid):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_5(self, base_fixture, fixture_only_sm):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_6(self, base_fixture, fixture_sm_not_valid_asa):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_7(self, base_fixture, fixture_csv_only_headers):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_9(self, base_fixture, fixture_empty_asa):
        _, _, union_dir_path = base_fixture
    ...
    def test_case_10(self, base_fixture, fixture_empty_sm):
        _, _, union_dir_path = base_fixture
