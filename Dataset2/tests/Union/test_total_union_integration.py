import os
import pytest
from Union.Union_TM_ASA import Union_TMwithASA
from Union.Total_Combination import TotalCombination


class TestTotalCombinationIntegration:

    def test_case_1(self, base_fixture, fixture_csv_asa, fixture_csv_sm, fixture_first_union):
    ...
    def test_case_2(self, base_fixture, fixture_csv_sm, fixture_first_union):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_3(self, base_fixture, fixture_csv_asa, fixture_first_union):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_4(self, base_fixture, fixture_csv_asa, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_5(self, base_fixture, fixture_csv_tm_header_asa_header, fixture_csv_sm_header):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_6(self, base_fixture, fixture_csv_tm_asa_not_valid, fixture_first_union, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_7(self, base_fixture, fixture_csv_asa, fixture_first_union_not_valid, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_8(self, base_fixture, fixture_csv_tm_asa_not_valid, fixture_first_union, fixture_tm_not_valid_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_9(self, base_fixture, fixture_csv_asa, fixture_first_union, fixture_tm_not_valid_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_10(self, base_fixture, fixture_csv_tm_empty_asa_empty, fixture_csv_sm_empty):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_11(self, base_fixture, fixture_csv_tm_empty_asa_empty, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_12(self, base_fixture, fixture_csv_tm_asa, fixture_csv_sm_empty):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_13(self, base_fixture, fixture_csv_tm_asa, fixture_first_union, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
    ...
    def test_case_14(self, base_fixture, fixture_csv_tm_asa, fixture_csv_sm):
        text_mining_dir, asa_dir, software_metrics_dir, union_tm_asa_dir, union_combination_dir = base_fixture
