...
class TestTextMiningIntegration:
    ...
    def test_case_4(self, setup_environment):
        text_mining_main()
        dict_gen_main()
        less_element_main()
        creator_csv_main()
    ...
    def test_case_5(self, setup_environment):
        text_mining_main()
        dict_gen_main()
        less_element_main()
        creator_csv_main()
    ...
    def test_case_7(self, setup_environment):
        text_mining_main()
        dict_gen_main()
        less_element_main()
        creator_csv_main()
    ...
    def test_case_11(self, setup_environment, create_temp_file):
        for i in range(1, 36, 1):
            if i != 18:
                repo_name = f"RepositoryMining{i}"
                repo_dir = os.path.join(self.BASE_DIR, "mining_results", repo_name, str(i), f"commit{i}")
